...
function App() {
    ...
    const topic1Chapters = [
        ...
        {
            id: 'chapter-2',
            title: 'Chapter 2 Lab 0 - Git Practice',
            overviewUrl: '/docs/topic-1-foundations/chapter-2-lab-0-git-practice/overview.md',
            markdownUrl: '/docs/topic-1-foundations/chapter-2-lab-0-git-practice/index.md'
        },
        {
            id: 'chapter-3',
    ...
    const topic4Chapters = [
        {
            id: 'chapter-1',
            title: 'Chapter 1 DataOps Prereequisite',
